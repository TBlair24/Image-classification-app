package com.example.katundaclassification;
...
public class MainActivity extends AppCompatActivity {
    ...
    private MappedByteBuffer loadmodelfile(Activity activity) throws IOException {
        AssetFileDescriptor fileDescriptor=activity.getAssets().openFd("katunda_model.tflite");
...
//To set components of x axis
    ...
    private void showresult(){
        ...
        try{
            labels = FileUtil.loadLabels(MainActivity.this,"katunda_labels.txt");
        }catch (Exception e){
            e.printStackTrace();
        }
